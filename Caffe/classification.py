...
import caffe  
import os 
if os.path.isfile(caffe_root + 'models/bvlc_reference_caffenet/vlc_reference_caffenet.caffemodel'):
...
image = caffe.io.load_image(caffe_root + 'example/images/cat.jpg')
...
print 'predicted class is:', output_prob.argmax() #Output the max   
...
for layer_name, blob in net_params.iteritems():
